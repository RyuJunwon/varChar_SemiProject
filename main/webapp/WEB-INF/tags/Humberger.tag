    ...
    <div class="humberger__menu__wrapper">
		...
		<ul>
			<c:if test="${empty ssMemberId}">
				<li><a href="signupPage.do"> <!-- signup.do --> <img
						src=img/signup.png alt="회원가입" width="26" height="26" border="1">
				</a></li>
				<li><a href="loginPage.do"> <!-- login.do --> <img
						src="img/login.jpg" alt="로그인" width="26" height="26" border="1">
				</a></li>
			</c:if>
			<c:if test="${not empty ssMemberId}">
				<li><a href="favorPage.do"> <!-- favorPage.do --> <img
						alt="찜"
						src="https://static.vecteezy.com/system/resources/thumbnails/001/188/163/small/heart.png"
						width="24" height="24" border="1">
				</a></li>
				<li><a href="cartPage.do"> <!-- cartPage.do --> <img
						src="https://cdn-icons-png.flaticon.com/512/263/263142.png"
						alt="장바구니" width="24" height="24" border="1">
				</a></li>
				<li><a href="logout.do"> <!-- logout.do --> <img
						src="img/logout.png" alt="로그아웃" width="24" height="24" border="1">
				</a></li>
			</c:if>
		</ul>
	</div>
