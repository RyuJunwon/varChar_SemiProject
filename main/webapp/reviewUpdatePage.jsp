					...
					<div class="breadcrumb__text">
						<h2>
							...
							<div class="breadcrumb__option">
								<a href="main.jsp">Home </a> <span>후 기 수 정</span>
							</div>
					</div>
				</div>
			</div>
	...
	<form action="updateReviews.do">
		...
		<div class="checkout__form">
			...
			<section class="blog-details spad">
				<div class="container">
					<textarea id="editor" name="reviewContent" placeholder="150자 이내로 작성해주세요">
					${ rdata.reviewContent }
					</textarea>
					<!-- CKEditor -->
					<script>
			...
			<div class="abc center-content"
				...
				<input class="primary-btn" type="submit" value="후기수정">
			</div>
		</div>
	</form>
